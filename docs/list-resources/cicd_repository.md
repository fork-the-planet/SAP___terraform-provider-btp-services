...
page_title: "btpservice_cicd_repository List Resource - SAP BTP Services"
subcategory: ""
description: |-
  This list resource discovers all repositories in the SAP BTP CI/CD service.
---

# btpservice_cicd_repository (List Resource)

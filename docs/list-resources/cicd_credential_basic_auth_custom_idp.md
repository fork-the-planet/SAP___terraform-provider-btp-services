...
page_title: "btpservice_cicd_credential_basic_auth_custom_idp List Resource - SAP BTP Services"
subcategory: ""
description: |-
  This list resource discovers all Basic Authentication credentials for custom Identity Providers in the SAP BTP CI/CD service.
---

# btpservice_cicd_credential_basic_auth_custom_idp (List Resource)
